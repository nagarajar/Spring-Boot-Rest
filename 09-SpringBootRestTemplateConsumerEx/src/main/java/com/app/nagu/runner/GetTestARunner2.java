...
public class GetTestARunner2 implements CommandLineRunner 
{
	public void run(String... args) throws Exception {
		...
		//Old Way
		//ResponseEntity<String> response = template.getForEntity(url, String.class, 101,"Raju");
		//Using Generic Method
		ResponseEntity<String> response = template.exchange(url,HttpMethod.GET,null, String.class, 101,"Raju");
